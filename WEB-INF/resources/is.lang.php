...
$i18n_language_name = "Icelandic";
$i18n_float_delimiter = ".";

$i18n_month = array ('janúar', 'febrúar', 'mars', 'apríl', 'maí', 'júní', 'júlí', 'ágúst', 'september', 'október', 'nóvember', 'desember');
// order of week day names must be from Sunday to Saturday in all translated files
$i18n_week = array ('sunnudagur', 'mánudagur', 'þriðjudagur', 'miðvikudagur', 'fimmtudagur', 'föstudagur', 'laugardagur');
$i18n_week_sn = array ("sun","mon","þri","mið","fim","fös","laus");

//format d/m
$i18n_holidays = array("01/01","09/04", "10/04", "12/04", "13/04", "23/04", "01/05", "21/05", "31/05", "01/06", "17/06", "03/08", "25/12", "26/12");
...
"menu.help" => 'hjálp',
"menu.register" => 'nýskráning',
"menu.edprof" => 'uppsetning',
"menu.mytime" => 'tími',
"menu.report" => 'skýrslur',
"menu.project" => 'verkefni',
"menu.activity" => 'í gangi',
"menu.people" => 'fólk',
"menu.profile" => 'teymi',
"menu.migration" => 'flytja út gögn',
"menu.clients" => 'viðskiptavinir',
"menu.services" => 'breyta lykilorði',
"menu.admin" => 'stjórnun',

// error strings
"errors.db_error" => 'gagnagrunnsvilla',
"errors.wrong" => 'röng \'{0}\' gögn',
"errors.empty" => 'svæði \'{0}\' er tómt',
// Note to translators: ALL THE STRINGS BELOW MUST BE TRANSLATED
